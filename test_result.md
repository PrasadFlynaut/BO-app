...
test_plan: "Test Sprint 9 backend API endpoints. All admin endpoints require 2FA: POST /api/v1/admin/login then POST /api/v1/admin/verify-2fa with code. Admin: admin@bo.com / BoAdmin2026!. Focus on: Enhanced User List (GET /api/v1/admin/users with ?tab=, ?plan=, ?status=, ?search=), User 360 (GET /api/v1/admin/user/all-data/:id), User Actions (POST /api/v1/admin/users/changeAction/:id with {action,reason}), Subscriber List (GET /api/v1/admin/users/subscribed), Ticket Queue (GET /api/v1/admin/tickets with ?status=), Ticket Detail (GET /api/v1/admin/tickets/:id), Ticket Status (PUT /api/v1/admin/ticket/change_status/:id), Ticket Message (POST /api/v1/admin/ticket/message), Ticket Report (POST /api/v1/admin/tickets/report), FAQ CRUD (GET /api/v1/admin/faqs, POST/PUT/DELETE /api/v1/admin/faq), Notification Broadcast (POST /api/v1/admin/notifications/broadcast), Notification History (GET /api/v1/admin/notifications/history), Notification Analytics (GET /api/v1/admin/notifications/analytics), Admin Profile (PUT /api/v1/admin/profile), Admin Team (GET /api/v1/admin/team), Create Admin (POST /api/v1/admin/users/create-admin)."
