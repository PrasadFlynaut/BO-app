...
const s = StyleSheet.create({
  ...
  filterRow: { paddingVertical: Spacing.sm, maxHeight: 52 },
  filterChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: Radius.pill, backgroundColor: '#FFF', borderWidth: 1, borderColor: Colors.borderLight, alignSelf: 'center', height: 36, justifyContent: 'center' },
