...
type Section = { icon: string; label: string; color: string; route?: string };
const SECTIONS: { title: string; items: Section[] }[] = [
  ...
  },
  {
    title: 'SOCIAL',
    items: [
      { icon: 'people-outline', label: 'Invite Your Friends', color: Colors.waterBlue, route: '/invite-friends' },
    ],
  },
  {
    title: 'SUPPORT',
    items: [
      { icon: 'help-circle-outline', label: 'Help and Support', color: Colors.socialTeal, route: '/help' },
      { icon: 'mail-outline', label: 'Contact Us', color: Colors.fitnessPurple, route: '/contact' },
    ],
  },
  {
    title: 'LEGAL',
    items: [
      { icon: 'information-circle-outline', label: 'About BO', color: Colors.textSecondary, route: '/about' },
...
const s = StyleSheet.create({
  ...
  row: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: Spacing.md, height: 56 },
