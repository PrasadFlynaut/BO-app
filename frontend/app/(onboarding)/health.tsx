        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.inputRow}>
            <View style={styles.inputHalf}>
              ...
              <TextInput testID="height-input" style={styles.input} value={height} onChangeText={setHeight} keyboardType="numeric" placeholder="170" placeholderTextColor={Colors.textMuted} />
            </View>
            <View style={styles.inputHalf}>
              <Text style={styles.label}>Weight (kg)</Text>
              <TextInput testID="weight-input" style={styles.input} value={weight} onChangeText={setWeight} keyboardType="numeric" placeholder="70" placeholderTextColor={Colors.textMuted} />
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  genderBtnActive: { borderColor: Colors.secondary, backgroundColor: 'rgba(219,255,2,0.08)' },
  ...
  activityChipActive: { borderColor: Colors.primary, backgroundColor: 'rgba(38,181,15,0.1)' },
  activityText: { color: Colors.textSecondary, fontWeight: '500' },
  activityTextActive: { color: Colors.primary },
  button: { backgroundColor: Colors.secondary, borderRadius: Radius.md, paddingVertical: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.sm, marginTop: Spacing.xl, marginBottom: Spacing.xxl },
