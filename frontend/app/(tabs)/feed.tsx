...
const styles = StyleSheet.create({
  ...
  postInput: { flex: 1, color: Colors.textPrimary, fontSize: FontSize.body, maxHeight: 80, paddingVertical: Spacing.xs, outlineStyle: 'none' as any },
  ...
  commentInput: { flex: 1, backgroundColor: Colors.greenLight, borderRadius: Radius.md, paddingVertical: 8, paddingHorizontal: Spacing.sm, color: Colors.textPrimary, fontSize: FontSize.small, outlineStyle: 'none' as any },
