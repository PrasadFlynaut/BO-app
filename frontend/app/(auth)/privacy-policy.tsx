...
const SECTIONS = [
  ...
  { title: '2. How We Use Your Information', body: 'Your information is used to provide personalized meal plans, nutrition tracking, and wellness recommendations. We use aggregated, de-identified data to improve our services. We do not sell your personal information to third parties.' },
