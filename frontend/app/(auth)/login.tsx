      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput testID="login-password-input" style={styles.input} placeholder="Enter your password" placeholderTextColor={Colors.textMuted} value={password} onChangeText={setPassword} secureTextEntry />
          </View>
...
const styles = StyleSheet.create({
  ...
  error: { color: Colors.danger, fontSize: FontSize.caption, textAlign: 'center', marginBottom: Spacing.md, backgroundColor: 'rgba(255,59,48,0.08)', padding: Spacing.sm, borderRadius: Radius.sm },
  ...
  button: { backgroundColor: Colors.green, borderRadius: Radius.md, paddingVertical: 18, alignItems: 'center', marginTop: Spacing.lg },
